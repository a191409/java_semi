...
<div class="main">
    ...
    <form action="/task/update?taskid=${currenttask.id}" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="description" id="description" value="${currenttask.description}"><br>
            <label for="title">期限日</label><br>
            <input type="date" class="form-control" name="limit" id="limit" value="${currenttask.limit}"><br>
